...
var Form$1 = import_react.forwardRef(({ discover = "render", fetcherKey, navigate, reloadDocument, replace: replace2, state, method = defaultMethod, action, onSubmit, relative, preventScrollReset, viewTransition, defaultShouldRevalidate, ...props }, forwardedRef) => {
...
var useFormValues = ({ initialValues, validate }) => {
	const [formValues, setFormValues] = (0, import_react.useState)(initialValues);
	...
	const [blur, setBlur] = (0, import_react.useState)(() => Object.keys(initialValues).reduce((acc, key) => {
		return {
			...acc,
			[key]: false
		};
	...
	const valids = Object.entries(errors).reduce((acc, [key, errorValue]) => {
	...
	const reset = () => {
		...
		setBlur(Object.keys(initialValues).reduce((acc, key) => {
			return {
				...acc,
				[key]: false
			};
...
//#endregion
//#region src/core/hooks/validateFormValueRules.ts
var validators = {
	isRequired,
	isNumericString,
	isValidMonth,
...
var validateFormValuesRules = (formValues, formValuesRules) => {
...
//#endregion
//#region src/pages/payments/register/form/constant.ts
var getRangeNumber = (min, max) => {
	return Array.from({ length: max - min + 1 }, (_, i) => min + i);
};
var toStringNumbers = (numbers) => {
...
var BRAND_NUMBER = {
	...
	mastercard: {
		startNumber: toStringNumbers(getRangeNumber(51, 55)),
		length: 16,
		lengths: [
			4,
			4,
...
//#endregion
//#region src/pages/payments/register/form/validator.ts
var validateCardNumbers = (cardNumbers) => {
	const cardBrand = getBrandCard(Object.values(cardNumbers));
	const length = (BRAND_NUMBER?.[cardBrand])?.length || 16;
	const rule = [
		{
			type: "isRequired",
			message: "카드번호는 필수값입니다"
		},
		{
			type: "isNumericString",
			message: "카드번호는 숫자여야합니다"
		},
		{
			type: "length",
			message: "카드번호는 한칸당 4자리여야합니다",
			length: 4
		}
	];
	return validateFormValuesRules(cardNumbers, {
		"0": rule,
		"1": rule,
		"2": rule,
		"3": [...rule.map((r) => r.type !== "length" ? r : {
			...r,
			length: length % 4 || 4
		})]
	});
};
var preventCardNumber = (cardNumber) => {
...
var validateCard = ({ card }) => {
	return validateFormValuesRules({ card }, { card: [{
		type: "isRequired",
		message: "카드사는 필수값입니다"
	}] });
};
var preventCard = (value) => {
	return false;
};
var validateExpirationDate = (expirationDate) => {
	return validateFormValuesRules(expirationDate, {
		month: [
			{
				type: "isRequired",
				message: "유효기간(월)는 필수값입니다"
			},
			{
				type: "isNumericString",
				message: "유효기간(월)는 숫자여야합니다"
			},
			{
				type: "isValidMonth",
				message: "유효기간(월)는 01부터 12까지의 숫자여야합니다"
			},
			{
				type: "length",
				message: "유효기간(월)은 2자리여야합니다",
				length: 2
			}
		],
		year: [
			{
				type: "isRequired",
				message: "유효기간(년)는 필수값입니다"
			},
			{
				type: "isNumericString",
				message: "유효기간(년)는 숫자여야합니다"
			},
			{
				type: "length",
				message: "유효기간(년)은 2자리여야합니다",
				length: 2
			}
		]
	});
};
var preventExpirationMonth = (month) => {
	if (isEmptyString(month)) return false;
	if (!isNumericString(month)) return true;
	if (month.length > 2) return true;
	return false;
};
var preventExpirationYear = (year) => {
...
var validateCvc = ({ cvc }) => {
	return validateFormValuesRules({ cvc }, { cvc: [
		{
			type: "isRequired",
			message: "CVC는 필수값입니다"
		},
		{
			type: "isNumericString",
			message: "CVC는 숫자여야합니다"
		},
		{
			type: "length",
			message: "CVC는 3자리여야합니다",
			length: 3
		}
	] });
};
...
var validatePassword = ({ password }) => {
	return validateFormValuesRules({ password }, { password: [
		{
			type: "isRequired",
		...
		{
			type: "isNumericString",
			message: "비밀번호는 숫자여야합니다"
		},
		{
			type: "length",
			message: "비밀번호는 2자리여야합니다",
			length: 2
		}
	] });
};
var preventPassword = (password) => {
...
//#endregion
//#region src/pages/payments/register/form/hooks/useCardNumbers.ts
var useCardNumbers = () => {
	...
	const handleChange = (e) => {
		...
		if (preventCardNumber(value)) {
			setInvalidAttemp(invalidAttemp.map((invalidAttemp, i) => {
				return Number(id) === i ? true : invalidAttemp;
			}));
			return;
		} else setInvalidAttemp(invalidAttemp.map((invalidAttemp, i) => {
			return Number(id) == i ? false : invalidAttemp;
		}));
		onChange(e);
	};
	const [invalidAttemp, setInvalidAttemp] = (0, import_react.useState)([
		false,
		false,
		false,
		false
	...
	const renderErrorCardNumberInput = (index) => {
		if (invalidAttemp[Number(index)]) return true;
...
//#endregion
//#region src/pages/payments/register/form/hooks/useCard.ts
var useCard = () => {
	const { values, onChange, blur, onBlur, refs, ref, errors, valids, isValid, reset } = useFormValues({
		initialValues: { card: "" },
...
//#endregion
//#region src/pages/payments/register/form/hooks/useExpirationDate.ts
var useExpirationDate = () => {
	...
	const handleChange = (e) => {
		const { id, value } = e.target;
		if (id === "month") if (preventExpirationMonth(value)) {
			setInvalidAttemp({
				...invalidAttemp,
				month: true
			});
		...
		if (id === "year") if (preventExpirationYear(value)) {
			setInvalidAttemp({
				...invalidAttemp,
				year: true
			});
...
//#endregion
//#region src/pages/payments/register/form/hooks/useCvc.ts
var useCvc = () => {
	const { values, onChange, blur, onBlur, refs, ref, errors, valids, isValid, reset } = useFormValues({
		initialValues: { cvc: "" },
...
//#endregion
//#region src/pages/payments/register/form/hooks/usePassword.ts
var usePassword = () => {
	const { values, onChange, blur, onBlur, refs, ref, errors, valids, isValid, reset } = useFormValues({
...
//#endregion
//#region src/pages/payments/register/flow/Flow.tsx
var Flow = () => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, { context: {
		cardNumbers,
		card,
		expirationDate,
		cvc,
...
//#endregion
//#region src/core/components/fullScreen/FullScreen.module.css
...
var FullScreen_module_default = {
	fullScreen: "_fullScreen_1l6ts_1",
	content: "_content_1l6ts_9",
	action: "_action_1l6ts_13"
};
//#endregion
//#region src/core/components/fullScreen/Content.tsx
var Content = ({ children }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: FullScreen_module_default.content,
		children
	});
};
//#endregion
//#region src/core/components/fullScreen/Action.tsx
var Action = ({ children }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: FullScreen_module_default.action,
		children
	});
};
//#endregion
//#region src/core/components/fullScreen/FullScreen.tsx
var FullScreen = ({ children }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: FullScreen_module_default.fullScreen,
		children
	});
};
...
var CreditCard = ({ card, cardBrand = "mastercard", cardNumberList, expirationDate }) => {
	const cardColor = cardColors[card];
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
var FormGroup_module_default = {
	formGroup: "_formGroup_gq4rv_1",
	hide: "_hide_gq4rv_12",
	titleContainer: "_titleContainer_gq4rv_16",
	title: "_title_gq4rv_16",
	subTitle: "_subTitle_gq4rv_33"
};
//#endregion
//#region src/core/components/formGroup/FormGroup.tsx
var FormGroup = ({ title, subTitle, children, hide }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", {
		className: (0, import_classnames.default)(FormGroup_module_default.formGroup, hide && FormGroup_module_default.hide),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: (0, import_classnames.default)(FormGroup_module_default.contentContainer),
			children
		})]
	});
};
var Field_module_default = {
	label: "_label_rz5l7_1",
	field: "_field_rz5l7_9",
	children: "_children_rz5l7_15",
	errorMessage: "_errorMessage_rz5l7_21",
	hidden: "_hidden_rz5l7_32"
};
//#endregion
//#region src/core/components/field/Field.tsx
var Field = ({ label, children, errorMessage, ...rest }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: (0, import_classnames.default)(Field_module_default.field),
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
				className: (0, import_classnames.default)(Field_module_default.label),
				children: label
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: (0, import_classnames.default)(Field_module_default.children),
				...rest,
				children
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: (0, import_classnames.default)(Field_module_default.errorMessage, errorMessage === "" && Field_module_default.hidden),
...
var Input = (0, import_react.forwardRef)(({ isError, ...rest }, ref) => {
...
var Select_module_default = {
	select: "_select_1kf4e_1",
	box: "_box_1kf4e_7",
	arrow: "_arrow_1kf4e_17",
	options: "_options_1kf4e_27",
	list: "_list_1kf4e_33"
};
//#endregion
//#region src/core/components/select/imgs/select-arrow-down.svg?react
var SvgSelectArrowDown = (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	width: 16,
	height: 16,
	viewBox: "0 0 16 16",
	fill: "none",
	...
	children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
		d: "M3.81991 5.72993L7.63984 9.54986L11.4598 5.72993",
		stroke: "black",
		strokeWidth: 1.32867,
		strokeLinecap: "round",
...
//#endregion
//#region src/core/components/select/Select.tsx
var Select = (0, import_react.forwardRef)(({ id, options, value, onChange, onBlur }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		tabIndex: 0,
		id,
		className: (0, import_classnames.default)(Select_module_default.select, open && Select_module_default.open),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: Select_module_default.box,
			onClick: handleClickOpen,
			children: [selectedOption?.text, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: Select_module_default.arrow,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SvgSelectArrowDown, {})
			})]
		}), open && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: Select_module_default.options,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
				className: Select_module_default.list,
				children: options.map((option) => {
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
						className: (0, import_classnames.default)(value === option.value && Select_module_default.selected),
...
//#endregion
//#region src/core/components/view/View.tsx
var View = (props) => {
	const { as, ...restProps } = props;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(as || "div", { ...restProps });
};
var Button_module_default = {
	button: "_button_16i7f_1",
	"variant-default": "_variant-default_16i7f_12",
	"variant-primary": "_variant-primary_16i7f_16",
	"edge-rounded": "_edge-rounded_16i7f_21",
	"edge-flat": "_edge-flat_16i7f_25",
	"size-normal": "_size-normal_16i7f_29",
	"size-large": "_size-large_16i7f_37",
	"is-block": "_is-block_16i7f_45"
};
//#endregion
//#region src/core/components/button/Button.tsx
var Button = ({ as = "button", children, variant = "default", edge = "rounded", size = "normal", block, ...rest }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View, {
		as,
		className: (0, import_classnames.default)(Button_module_default.button, Button_module_default[`variant-${variant}`], Button_module_default[`edge-${edge}`], Button_module_default[`size-${size}`], block && Button_module_default["is-block"]),
		...rest,
		children
	});
};
...
var Form = () => {
	...
	const branchNumberCard = BRAND_NUMBER?.[brandCard];
	const isValid = cardNumbers.isValid && card.isValid && expirationDate.isValid && cvc.isValid && password.isValid;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: (0, import_classnames.default)(Form_module_default.payments),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FullScreen, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FullScreen.Content, { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormGroup, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
						...
						maxLength: 2,
						isError: !!password.invalidAttemp.password || password.blur.password && !password.errors.password.length,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormGroup, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Field, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
						...
						isError: expirationDate.invalidAttemp.month || Object.values(expirationDate.blur).includes(true) && !expirationDate.errors.month?.length,
						placeholder: "MM"
						...
						onChange: expirationDate.onChange,
						onBlur: expirationDate.onBlur,
						isError: expirationDate.invalidAttemp.year || Object.values(expirationDate.blur).includes(true) && !expirationDate.errors.year?.length,
						placeholder: "YY"
					})]
				})
			}),
		...
		] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FullScreen.Action, { children: isValid && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
			variant: "primary",
			edge: "flat",
			block: true,
...
var SymbolInfo_module_default = {
	symbolInfo: "_symbolInfo_ywfb2_1",
	"is-full": "_is-full_ywfb2_7",
	box: "_box_ywfb2_15",
	symbol: "_symbol_ywfb2_1",
	content: "_content_ywfb2_25",
	action: "_action_ywfb2_33"
};
//#endregion
//#region src/core/components/symbolInfo/imgs/symbol-complete.svg?react
var SvgSymbolComplete = (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
	width: 76,
	height: 76,
	viewBox: "0 0 76 76",
	fill: "none",
...
//#endregion
//#region src/core/components/symbolInfo/SymbolInfo.tsx
var symbols = { complete: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SvgSymbolComplete, {}) };
var SymbolInfo = ({ children, full, symbol, action, ...rest }) => {
	const symbolImg = symbols[symbol] || null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: (0, import_classnames.default)(SymbolInfo_module_default.symbolInfo, full && SymbolInfo_module_default[`is-full`]),
		...rest,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: SymbolInfo_module_default.box,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: SymbolInfo_module_default.symbol,
					children: symbolImg
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: SymbolInfo_module_default.content,
					children
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: SymbolInfo_module_default.action,
					children: action
				})
			]
		})
...
//#endregion
//#region src/pages/payments/register/complete/Complete.tsx
var Complete = () => {
	const navigate = useNavigate();
	const outletContext = useOutletContext();
	if (!outletContext) return null;
	const { cardNumbers: { values: cardNumbers }, card: { values: { card } }, handleReset } = outletContext;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SymbolInfo, {
		full: true,
		symbol: "complete",
...
//#endregion
//#region src/routes/AppRoutes.tsx
var AppRoutes = () => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Routes, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
		...
		element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flow, {}),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
			index: true,
			element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Form, {})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
			path: "complete",
			element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Complete, {})
		})]
	})] });
};
//#endregion
//#region src/App.tsx
function App() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppRoutes, {});
}
//#endregion
//#region src/main.tsx
